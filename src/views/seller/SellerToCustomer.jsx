                ...
                <div className='flex w-full h-full relative'>
                    <div className={`w-[280px] h-full absolute z-10 ${show ? '-left-[16px]' : '-left-[336px]'} md:left-0 md:relative transition-all`}>
                        <div className='w-full h-[calc(100vh-177px)] bg-[#252b3b] md:bg-transparent overflow-y-auto'>
                            ...
                            {
                                customers.map((c, i) => <Link key={i} to={`/seller/dashboard/chat-customer/${c.fdId}`} className={`h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-sm cursor-pointer bg-secondary`}>
                    ...
                    <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
                        ...
                        <form onSubmit={send} className='flex gap-3'>
                            <input readOnly={customerId ? false : true} onChange={(e) => setText(e.target.value)} value={text} className='w-full flex justify-between px-2 border border-secondary items-center py-[5px] focus:border-blue-500 rounded-md outline-none bg-transparent text-white' type="text" placeholder='input your message' />
