        ...
        <div className='min-w-screen min-h-screen bg-secondary flex justify-center items-center'>
            <div className='w-[350px] text-white p-2'>
                <div className='bg-primary p-4 rounded-md'>
                    ...
                    <p className='text-sm mb-3'>Please signin to your account and start your business</p>
                    <form onSubmit={submit}>
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            <label htmlFor="email">Email</label>
                            <input onChange={inputHandle} value={state.email} className='px-3 py-2 outline-none border border-white bg-transparent rounded-md text-white focus:border-secondary overflow-hidden' type="text" name='email' placeholder='email' id='email' required />
                        </div>
