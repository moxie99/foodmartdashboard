        ...
        <div className='px-2 lg:px-7 pt-5'>
            <div className='w-full p-4  bg-primary rounded-md'>
                <div className='flex justify-between items-center p-4'>
                    ...
                    <select onChange={status_update} value={status} name="" id="" className='px-4 py-2 focus:primary outline-none bg-primary border border-secondary rounded-md text-white'>
                        ...
                        <div className='w-[68%]'>
                            <div className='pl-3'>
                                <div className='mt-4 flex flex-col'>
                                    {
                                        order?.suborder?.map((o, i) => <div key={i + 20} className='text-white mb-6'>
                                            <div className='flex justify-start items-center gap-3'>
