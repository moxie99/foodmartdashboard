        ...
        <div className='px-2 lg:px-7 pt-5'>
            <div className='w-full p-4  bg-primary rounded-md'>
                <div className='flex justify-between items-center'>
                    ...
                    <input className='px-4 py-2 focus:primary outline-none bg-primary border border-secondary rounded-md text-white' type="text" placeholder='search' />
                </div>
                <div className='relative mt-5 overflow-x-auto'>
                    <div className='w-full text-sm text-left white'>
                        ...
                        {
                            myOrders.map((o, i) => <div className='text-white'>
                                ...
                                <div className={show === o._id ? 'block border-b border-secondary bg-secondary' : 'hidden'}>
                                    {
                                        o.suborder.map((so, i) => <div className='flex justify-start items-start border-b border-secondary'>
